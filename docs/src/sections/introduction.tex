...
to upload an audio file\footnote{Of either of the .mp3 or .wav format} of their choosing to a website using a standard web browser\footnote{Chromium-based browsers and Firefox}.
